...
var SvgCompa = function SvgCompa(props) {
    ...
    <path onClick={((e) => props.handleClick(e))} onClick={((e) => props.handleClick(e))} d="M5.063 17.005V5.013H41.93v23.984H5.063z" fill="#fff" />
    <text
        y={20.666}
        x={20.156}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.012 15.984V5.014H87.983V26.954H46.012z" fill="#fff" />
    <text
        y={16.967}
        x={64.295}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.003 15.984V5.014h50.008V26.954H89.003z" fill="#fff" />
    <text
        y={18.498}
        x={111.113}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M139.989 15.984V5.014h71.056V26.954h-71.056z" fill="#fff" />
    <text
        y={19.263}
        x={171.071}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.98 15.984V5.014h73.991V26.954H211.98z" fill="#fff" />
    <text
        y={19.135}
        x={242.51}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.053 17.005V5.013h56.896v23.984h-56.896z" fill="#fff" />
    <text
        y={20.921}
        x={315.224}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.05 17.005V5.013h64.932v23.984H416.049z" fill="#fff" />
    <text
        y={19.646}
        x={445.345}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.055 17.005V5.013h70.929v23.984h-70.929z" fill="#fff" />
    <text
        y={19.646}
        x={559.903}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M668.977 17.005V5.013h52.048v23.984h-52.048z" fill="#fff" />
    <text
        y={19.773}
        x={690.789}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M4.976 45.005V30.031H41.96V59.98H4.976z" fill="#fff" />
    <text
        y={47.989}
        x={20.206}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.05 45.501V31.024h41.945v28.955H46.05z" fill="#fff" />
    <text
        y={47.899}
        x={63.685}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.018 45.501V31.024H137.007v28.955H89.018z" fill="#fff" />
    <text
        y={48.44}
        x={109.87}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.997 45.501V31.024h73.969v28.955h-73.969z" fill="#fff" />
    <text
        y={47.628}
        x={244.907}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M289.995 45.005V30.031h57.01V59.98h-57.01z" fill="#fff" />
    <text
        y={46.997}
        x={316.801}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M347.997 45.005V30.031h67.022V59.98H347.997z" fill="#fff" />
    <text
        y={47.177}
        x={378.05}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.012 45.005V30.031h64.947V59.98h-64.947z" fill="#fff" />
    <text
        y={46.456}
        x={444.441}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M484.989 45.005V30.031h42.035V59.98H484.99z" fill="#fff" />
    <text
        y={46.185}
        x={503.436}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.017 45.005V30.031h70.991V59.98h-70.991z" fill="#fff" />
    <text
        y={47.989}
        x={562.069}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M599.97 45.005V30.031H665.008V59.98H599.97z" fill="#fff" />
    <text
        y={48.801}
        x={629.813}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M668.977 45.005V30.031h52.049V59.98h-52.049z" fill="#fff" />
    <text
        y={48.26}
        x={690.07}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M722.018 45.005V30.031h33.015V59.98h-33.015z" fill="#fff" />
    <text
        y={48.711}
        x={736.255}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.07 91.062V61.114H87.925v59.896H46.07z" fill="#fff" />
    <text
        y={95.618}
        x={63.865}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M88.948 91.062V61.114H136.937v59.896H88.948z" fill="#fff" />
    <text
        y={95.257}
        x={108.788}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M212.048 91.062V61.114h73.968v59.896h-73.968z" fill="#fff" />
    <text
        y={93.994}
        x={244.998}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.106 90.07V61.113h56.829v57.911h-56.829z" fill="#fff" />
    <text
        y={93.272}
        x={313.734}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M415.972 90.07V61.113h64.948v57.911h-64.948z" fill="#fff" />
    <text
        y={89.484}
        x={445.434}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.007 90.07V61.113H598.908v57.911H528.007z" fill="#fff" />
    <text
        y={90.205}
        x={559.994}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.088 91.062V61.114h51.958v59.896h-51.958z" fill="#fff" />
    <text
        y={95.437}
        x={693.137}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M5.082 157.949v-34.954H42.077v69.908H5.082z" fill="#fff" />
    <text
        y={159.972}
        x={19.135}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.159 157.949v-34.954h41.843v69.908H46.159z" fill="#fff" />
    <text
        y={160.482}
        x={63.274}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.022 157.949v-34.954h47.967v69.908H89.022z" fill="#fff" />
    <text
        y={159.972}
        x={110.73}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.914 157.949v-34.954h73.991v69.908h-73.991z" fill="#fff" />
    <text
        y={160.227}
        x={244.678}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M289.987 157.949v-34.954h56.896v69.908h-56.896z" fill="#fff" />
    <text
        y={157.676}
        x={316.117}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.026 157.949v-34.954h65.06v69.908h-65.06z" fill="#fff" />
    <text
        y={160.738}
        x={443.687}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.032 157.949v-34.954h70.928v69.908h-70.928z" fill="#fff" />
    <text
        y={160.482}
        x={557.479}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.039 157.949v-34.954h52.048v69.908h-52.048z" fill="#fff" />
    <text
        y={158.952}
        x={691.937}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M4.98 218.497V197.03H41.963v42.938H4.979z" fill="#fff" />
    <text
        y={224.07}
        x={19.304}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.113 218.497V197.03H87.968v42.938H46.113z" fill="#fff" />
    <text
        y={221.364}
        x={62.783}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.05 218.497V197.03H139.025v42.938H89.051z" fill="#fff" />
    <text
        y={221.364}
        x={111.855}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M140.107 218.497V197.03H211.008v42.938H140.107z" fill="#fff" />
    <text
        y={222.807}
        x={170.488}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.97 218.497V197.03h73.969v42.938H211.97z" fill="#fff" />
    <text
        y={221.725}
        x={245.539}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M289.968 218.497V197.03h57.01v42.938h-57.01z" fill="#fff" />
    <text
        y={220.823}
        x={315.358}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M347.94 218.497V197.03h67.113v42.938H347.94z" fill="#fff" />
    <text
        y={221.003}
        x={377.96}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.015 218.497V197.03h64.948v42.938h-64.948z" fill="#fff" />
    <text
        y={220.823}
        x={443.99}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M485.112 218.497V197.03H526.967v42.938H485.112z" fill="#fff" />
    <text
        y={221.725}
        x={501.361}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.11 218.497V197.03H599.01v42.938H528.11z" fill="#fff" />
    <text
        y={221.725}
        x={557.469}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M599.973 218.497V197.03h64.948v42.938h-64.948z" fill="#fff" />
    <text
        y={219.56}
        x={628.19}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.07 218.497V197.03H719.947v42.938h-50.875z" fill="#fff" />
    <text
        y={220.101}
        x={691.514}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M724.096 218.497V197.03h30.85v42.938h-30.85z" fill="#fff" />
    <text
        y={221.183}
        x={737.699}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.136 281.922v-40.95h41.843v81.9H46.136z" fill="#fff" />
    <text
        y={287.797}
        x={61.744}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.976 281.922v-40.95h73.99v81.9h-73.99z" fill="#fff" />
    <text
        y={281.674}
        x={245.444}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.049 281.922v-40.95h56.896v81.9h-56.896z" fill="#fff" />
    <text
        y={284.735}
        x={315.352}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.002 281.922v-40.95h65.06v81.9h-65.06z" fill="#fff" />
    <text
        y={283.715}
        x={445.473}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.093 281.922v-40.95h70.929v81.9h-70.929z" fill="#fff" />
    <text
        y={283.97}
        x={560.285}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.015 281.922v-40.95h51.028v81.9h-51.028z" fill="#fff" />
    <text
        y={281.674}
        x={688.875}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M724.125 281.922v-40.95h30.872v81.9h-30.872z" fill="#fff" />
    <text
        y={280.908}
        x={738.117}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M45.983 352.061v-26.917H88.08v53.834H45.983z" fill="#fff" />
    <text
        y={356.174}
        x={63.785}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.101 352.061v-26.917h49.752v53.834H89.101z" fill="#fff" />
    <text
        y={354.643}
        x={108.944}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M140.044 352.061v-26.917h70.929v53.834h-70.929z" fill="#fff" />
    <text
        y={354.643}
        x={169.667}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.908 352.061v-26.917h73.99v53.834h-73.99z" fill="#fff" />
    <text
        y={355.409}
        x={246.464}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.066 352.061v-26.917h56.896v53.834h-56.896z" fill="#fff" />
    <text
        y={354.133}
        x={310.759}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M347.982 352.061v-26.917h67.101v53.834h-67.1z" fill="#fff" />
    <text
        y={354.643}
        x={377.606}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.104 352.061v-26.917h64.806v53.834h-64.806z" fill="#fff" />
    <text
        y={354.898}
        x={443.687}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M485.077 352.061v-26.917h41.843v53.834h-41.843z" fill="#fff" />
    <text
        y={356.684}
        x={501.859}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M527.94 352.061v-26.917h70.929v53.834H527.94z" fill="#fff" />
    <text
        y={356.174}
        x={558.755}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M600.06 352.061v-26.917h64.805v53.834H600.06z" fill="#fff" />
    <text
        y={355.919}
        x={626.366}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M668.947 353.082v-27.938h51.028v55.876h-51.028z" fill="#fff" />
    <text
        y={356.174}
        x={691.682}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M724.057 353.082v-27.938h30.872v55.876h-30.872z" fill="#fff" />
    <text
        y={357.45}
        x={737.097}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.128 403.89v-20.928h41.856V424.817H46.128z" fill="#fff" />
    <text
        y={409.532}
        x={63.144}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M212.106 403.89v-20.928h73.968V424.817h-73.968z" fill="#fff" />
    <text
        y={410.614}
        x={243.915}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.164 403.89v-20.928h56.649V424.817h-56.649z" fill="#fff" />
    <text
        y={408.089}
        x={314.275}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.09 403.89v-20.928h64.948V424.817H416.09z" fill="#fff" />
    <text
        y={408.45}
        x={443.088}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.185 403.89v-20.928h70.721V424.817h-70.72z" fill="#fff" />
    <text
        y={406.285}
        x={555.665}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M724.111 403.348V381.88h30.67v42.938h-30.67z" fill="#fff" />
    <text
        y={408.45}
        x={736.436}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M4.976 456v-29.046H41.78v58.092H4.976z" fill="#fff" />
    <text
        y={461.49}
        x={20.206}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.11 455.94v-28.866H87.964v57.732H46.109z" fill="#fff" />
    <text
        y={460.408}
        x={63.144}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.167 455.94v-28.866h49.794v57.732H89.167z" fill="#fff" />
    <text
        y={462.212}
        x={109.69}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M139.923 455.94v-28.866h71.082v57.732h-71.082z" fill="#fff" />
    <text
        y={461.851}
        x={167.782}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.967 455.94v-28.866h73.968v57.732h-73.968z" fill="#fff" />
    <text
        y={461.49}
        x={246.441}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M289.904 455.94v-28.866h57.01v57.732h-57.01z" fill="#fff" />
    <text
        y={461.49}
        x={313.193}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M348.117 455.94v-28.866h66.752v57.732h-66.752z" fill="#fff" />
    <text
        y={461.851}
        x={377.419}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M415.951 455.94v-28.866H480.9v57.732H415.95z" fill="#fff" />
    <text
        y={459.325}
        x={443.449}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M485.108 455.94v-28.866h41.856v57.732h-41.856z" fill="#fff" />
    <text
        y={461.49}
        x={500.459}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.166 455.94v-28.866h70.721v57.732h-70.72z" fill="#fff" />
    <text
        y={460.047}
        x={559.273}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M599.97 455.94v-28.866h64.948v57.732H599.97z" fill="#fff" />
    <text
        y={459.325}
        x={627.829}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M668.887 455.94v-28.866h51.236v57.732h-51.236z" fill="#fff" />
    <text
        y={456.8}
        x={688.808}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M724.092 455.94v-28.866h31.031v57.732h-31.031z" fill="#fff" />
    <text
        y={457.16}
        x={737.158}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M4.977 509.004v-21.942H41.972v43.884H4.977z" fill="#fff" />
    <text
        y={510.788}
        x={20.411}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M46.14 509.004v-21.942h41.842v43.884H46.14z" fill="#fff" />
    <text
        y={510.788}
        x={61.489}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.003 509.004v-21.942H139.01v43.884H89.003z" fill="#fff" />
    <text
        y={511.554}
        x={111.496}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M140.116 509.004v-21.942h70.928v43.884h-70.928z" fill="#fff" />
    <text
        y={514.871}
        x={170.178}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M212.065 509.004v-21.942h73.99v43.884h-73.99z" fill="#fff" />
    <text
        y={516.657}
        x={245.444}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.052 509.004v-21.942H346.95v43.884H290.052z" fill="#fff" />
    <text
        y={513.085}
        x={315.607}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M348.054 509.004v-21.942H414.901v43.884H348.054z" fill="#fff" />
    <text
        y={513.595}
        x={378.371}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M415.921 509.004v-21.942h65.06v43.884h-65.06z" fill="#fff" />
    <text
        y={512.319}
        x={444.197}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.097 510.025v-22.963h70.929v45.925h-70.929z" fill="#fff" />
    <text
        y={514.871}
        x={561.561}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M45.202 566.818v-31.893h42.863v63.785H45.202z" fill="#fff" />
    <text
        y={575.594}
        x={61.744}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M89.086 566.818v-31.893h47.966v63.785H89.086z" fill="#fff" />
    <text
        y={573.553}
        x={110.22}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M212.233 566.818v-31.893h73.48v63.785h-73.48z" fill="#fff" />
    <text
        y={573.553}
        x={243.913}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.305 566.818v-31.893H346.946v63.785h-56.64z" fill="#fff" />
    <text
        y={572.532}
        x={308.718}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.174 566.818v-31.893h64.805v63.785h-64.805z" fill="#fff" />
    <text
        y={580.186}
        x={441.901}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M485.232 566.307v-32.402h41.842v64.805h-41.842z" fill="#fff" />
    <text
        y={574.063}
        x={499.562}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.095 566.307v-32.402h70.929v64.805h-70.929z" fill="#fff" />
    <text
        y={574.573}
        x={557.734}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.272 566.307v-32.402H719.789v64.805h-50.518z" fill="#fff" />
    <text
        y={572.532}
        x={693.468}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M5.222 633.97v-32.835h37.886V666.804H5.222z" fill="#fff" />
    <text
        y={640.818}
        x={20.928}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M44.912 633.97v-32.835H87.85V666.804H44.912z" fill="#fff" />
    <text
        y={638.653}
        x={62.783}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M88.932 633.97v-32.835H136.921V666.804H88.932z" fill="#fff" />
    <text
        y={637.21}
        x={107.164}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M140.89 633.97v-32.835h70V666.804h-70z" fill="#fff" />
    <text
        y={640.097}
        x={168.143}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.972 633.97v-32.835h73.968V666.804h-73.968z" fill="#fff" />
    <text
        y={640.457}
        x={241.389}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.03 633.609v-32.474h57.009v64.948H290.03z" fill="#fff" />
    <text
        y={641.901}
        x={314.997}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M348.122 633.609v-32.474h66.752v64.948h-66.752z" fill="#fff" />
    <text
        y={642.262}
        x={373.811}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.197 633.609v-32.474H480.784v64.948H416.197z" fill="#fff" />
    <text
        y={639.375}
        x={442.367}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M485.114 633.609v-32.474H526.969v64.948H485.114z" fill="#fff" />
    <text
        y={642.262}
        x={499.376}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.172 633.609v-32.474h70.72v64.948h-70.72z" fill="#fff" />
    <text
        y={639.736}
        x={558.551}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M600.095 633.609v-32.474h64.948v64.948h-64.948z" fill="#fff" />
    <text
        y={642.262}
        x={627.468}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.012 633.609v-32.474h50.876v64.948h-50.876z" fill="#fff" />
    <text
        y={642.622}
        x={691.694}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M724.218 633.609v-32.474h30.67v64.948h-30.67z" fill="#fff" />
    <text
        y={643.344}
        x={736.797}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M88.932 698.016v-29.047H136.921v58.093H88.932z" fill="#fff" />
    <text
        y={702.158}
        x={107.525}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M211.972 698.918v-29.949h73.968V728.866h-73.968z" fill="#fff" />
    <text
        y={706.488}
        x={239.224}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M289.91 699.459v-29.407h57.009v58.814h-57.01z" fill="#fff" />
    <text
        y={704.684}
        x={313.914}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M416.197 699.459v-29.407H480.784v58.814H416.197z" fill="#fff" />
    <text
        y={704.323}
        x={442.728}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M528.172 699.459v-29.407h70.72v58.814h-70.72z" fill="#fff" />
    <text
        y={703.601}
        x={560.355}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M668.892 699.459v-29.407h51.959v58.814h-51.96z" fill="#fff" />
    <text
        y={706.488}
        x={691.694}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M4.805 762.082v-30.67h38.247v61.34H4.805z" fill="#fff" />
    <text
        y={768.549}
        x={19.845}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M45.214 761.91v-31.03h42.577v62.06H45.214z" fill="#fff" />
    <text
        y={770.353}
        x={63.865}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M141.192 760.467v-30.31H210.831V790.776H141.192z" fill="#fff" />
    <text
        y={767.106}
        x={168.864}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M212.034 760.467v-30.31h73.968V790.776h-73.968z" fill="#fff" />
    <text
        y={763.137}
        x={242.472}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M290.211 760.467v-30.31h56.649V790.776h-56.649z" fill="#fff" />
    <text
        y={762.415}
        x={311.028}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M348.063 760.467v-30.31h66.752V790.776h-66.752z" fill="#fff" />
    <text
        y={763.137}
        x={373.45}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M415.898 760.467v-30.31h64.947V790.776h-64.947z" fill="#fff" />
    <text
        y={762.415}
        x={443.088}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M484.935 760.467v-30.31H526.79V790.776H484.935z" fill="#fff" />
    <text
        y={762.054}
        x={503.345}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M527.872 760.467v-30.31h71.082V790.776h-71.082z" fill="#fff" />
    <text
        y={764.58}
        x={560.355}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M600.157 760.467v-30.31h64.948V790.776h-64.948z" fill="#fff" />
    <text
        y={763.497}
        x={630.354}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M669.074 761.549v-31.391h51.958v62.782h-51.958z" fill="#fff" />
    <text
        y={764.58}
        x={691.694}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M45.214 816.574v-22.551h42.577v45.102H45.214z" fill="#fff" />
    <text
        y={820.868}
        x={64.226}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M212.154 817.115v-22.01h74.69v44.02h-74.69z" fill="#fff" />
    <text
        y={822.311}
        x={245.358}
        style={{
    ...
    <path onClick={((e) => props.handleClick(e))} d="M722.114 816.574v-22.551h32.835v45.102h-32.835z" fill="#fff" />
    <text
        y={819.786}
        x={736.075}
        style={{
